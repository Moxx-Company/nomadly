...
🔹 मासिक लाइसेंस (Windows/WHM/Plesk) पहले से ही बिल किए जाते हैं।`,
  ...
  askVpsConfig: `⚙️ अपनी आवश्यकताओं के अनुसार एक VPS योजना चुनें (घंटेवार या मासिक बिलिंग उपलब्ध):
...
${formattedConfigurations}`,
  ...
  askVpsOS: `💻 एक ऑपरेटिंग सिस्टम चुनें (Windows Server के लिए $15/महीना अतिरिक्त शुल्क)।  
...
<strong>• Windows Server –</strong> Windows-आधारित अनुप्रयोगों के लिए (+$15/महीना)`,
  ...
  askVpsCpanel: `🛠️ क्या आप सर्वर प्रबंधन को आसान बनाने के लिए एक नियंत्रण पैनल जोड़ना चाहेंगे? WHM, Plesk, या बिना नियंत्रण पैनल के चुनें।

भुगतान किया गया नियंत्रण पैनल $20/महीना अतिरिक्त शुल्क जोड़ता है।`,
...
<strong>•🖥️ VPS योजना:</strong> ${vpsConfig[vpsDetails.config.name]}
...
<strong>•🛠️ नियंत्रण पैनल (${
    vpsDetails.panel
      ? `${vpsDetails.panel.name} ${vpsDetails.panel.mode === 'paid' ? 'भुगतानित' : 'परीक्षण'}`
      : 'चयनित नहीं'
...
<strong>✅ क्या आप ऑर्डर की पुष्टि करना चाहते हैं?</strong>`,
