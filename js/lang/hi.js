...
const formattedConfigurations = Object.entries(vpsConfigurationDetails)
  .map(
    ([key, { vcpuCount, ramGb, diskStorageGb, amountMonthly, amountHourly }]) =>
      `<strong>• ${key} -</strong>  $${amountMonthly}/महीना ($${amountHourly}/घंटा) – ${vcpuCount} vCPU, ${ramGb}GB RAM, ${diskStorageGb}GB डिस्क`,
  )
  .join('\n')
...
const vp = {
  ...
  askCountryForUser: '🌍 कृपया वह देश चुनें जहां आप अपना VPS होस्ट करना चाहते हैं।',
  chooseValidCountry: 'कृपया सूची से देश चुनें:',
  askRegionForUser: '🌍 अब, प्रदर्शन और कम विलंबता के लिए सर्वोत्तम क्षेत्र चुनें।',
  chooseValidRegion: 'कृपया सूची से वैध क्षेत्र चुनें:',
  askZoneForUser: region => `📍 ${region} के भीतर डेटा सेंटर स्थान चुनें। स्थान के अनुसार कीमतें भिन्न हो सकती हैं।`,
...
<strong>• मासिक –</strong> $${generateBilingCost(vpsDetails, 'monthly')} → 10% की बचत
<strong>• त्रैमासिक –</strong> $${generateBilingCost(vpsDetails, 'quaterly')} → 15% की बचत
<strong>• वार्षिक –</strong> $${generateBilingCost(vpsDetails, 'annually')} → 20% की बचत
`,
  planTypeMenu: vpsOptionsOf(vpsPlanMenu),

  askVpsConfig: `⚙️ अपने आवश्यकताओं के अनुसार VPS कॉन्फ़िगरेशन चुनें। हम विभिन्न कार्यभारों के लिए बेसिक, स्टैंडर्ड और प्रीमियम योजनाएं प्रदान करते हैं।
...
${formattedConfigurations}`,
  ...
  couponInvalid: `❌ अमान्य: कोड अमान्य है। कृपया फिर से प्रयास करें।`,
  ...
  askVpsOS: '💻 एक OS चुनें (Windows Server जोड़ने पर $15/महीना)。',
  ...
  askVpsCpanel:
    '🛠️ क्या आप आसानी से सर्वर प्रबंधन के लिए कंट्रोल पैनल जोड़ना चाहेंगे? WHM, Plesk, या बिना कंट्रोल पैनल में से चुनें।',
  ...
  validCpanel: 'कृपया एक वैध कंट्रोल पैनल चुनें या इसे छोड़ें।',
  trialPanelWarning: panel => `ℹ️ ${panel} का ट्रायल ऑटो-रिन्यू होता है $20/महीना पर जब तक इसे रद्द नहीं किया जाता।`,
...
अधिक जानने के लिए ${TG_HANDLE} पर जाएं।`,
  ...
  generateBillSummary: vpsDetails => `<strong>📋 अंतिम लागत का विवरण:</strong>

<strong>• VPS (${vpsPlans[vpsDetails.plan]} योजना) –</strong> $${vpsDetails.plantotalPrice}
<strong>• OS लाइसेंस (${vpsDetails.os ? vpsDetails.os.name : 'चयनित नहीं'}) –</strong> $${vpsDetails.selectedOSPrice}
<strong>• कंट्रोल पैनल (${
    vpsDetails.panel ? `${vpsDetails.panel.name} ${vpsDetails.panel.mode === 'paid' ? 'PAID' : 'TRIAL'}` : 'चयनित नहीं'
...
<strong>क्या आप आगे बढ़ना चाहते हैं?</strong>`,
...
कृपया अपनी वॉलेट को टॉप-अप करें ताकि आप अपनी VPS योजना का उपयोग जारी रख सकें।`,
  ...
  vpsBoughtSuccess: (vpsDetails, response) =>
    `<strong>🎉 VPS [ID] सक्रिय हो गया!

<strong>🔑 लॉगिन विवरण:
  <strong>• IP: ${response.networkInterfaces[0].networkIP}
  <strong>• OS: ${vpsDetails.os ? vpsDetails.os.name : 'चयनित नहीं'}
  <strong>• उपयोगकर्ता नाम: [User]
  <strong>• पासवर्ड: ईमेल द्वारा भेजा गया (तुरंत बदलें).
