...
const vpsOsMenu = ['Ubuntu', 'CentOS', 'Windows Server', 'अन्य ऑपरेटिंग सिस्टम']
...
const vp = {
  askCountryForUser: '🌍 उस देश का चयन करें जहां आप अपना VPS होस्ट करना चाहते हैं।',
  chooseValidCountry: 'कृपया सूची से देश चुनें:',
  askRegionForUser:
    '🌍 अगला, उस क्षेत्र का चयन करें जहां आप अपने VPS को होस्ट करना चाहते हैं ताकि बेहतर प्रदर्शन और कनेक्टिविटी सुनिश्चित हो सके।',
  chooseValidRegion: 'कृपया सूची से मान्य क्षेत्र चुनें:',
  askZoneForUser: 'चयनित क्षेत्र के भीतर डेटा सेंटर स्थान चुनें।',
  chooseValidZone: '📍 कृपया सूची से मान्य ज़ोन चुनें:',
  confirmZone: (region, zone) => `✅  आपने ${region} (${zone}) चुना है। क्या आप इस चयन के साथ आगे बढ़ना चाहते हैं?`,
  confirmBtn: `✅ चयन की पुष्टि करें`,
  askPlanType: `💳 अपनी ज़रूरतों के आधार पर एक बिलिंग प्लान चुनें:

<strong>- प्रति घंटा:</strong> अस्थायी या अल्पकालिक प्रोजेक्ट्स के लिए लचीला।
<strong>- मासिक/त्रैमासिक/वार्षिक:</strong> लंबे समय तक उपयोग के लिए सबसे अच्छा, लंबी अवधि के लिए छूट के साथ।`,
  planTypeMenu: kOf(vpsPlanMenu),
  askVpsConfig: `⚙️ अपने कार्यभार के लिए उपयुक्त VPS कॉन्फ़िगरेशन चुनें। हम विभिन्न कार्यभार के लिए बेसिक, स्टैंडर्ड और प्रीमियम प्लान पेश करते हैं।
  
${formattedConfigurations}`,
  validVpsConfig: 'कृपया मान्य VPS कॉन्फ़िगरेशन चुनें:',
...
<strong>- डिस्क स्टोरेज:</strong> ${config.diskStorageGb} GB डिस्क
<strong>- बैंडविड्थ:</strong> ${config.bandwidthTB} TB`
  },
  askVpsOS:
    '💻 अपने VPS के लिए ऑपरेटिंग सिस्टम चुनें। लोकप्रिय विकल्पों में Ubuntu और CentOS शामिल हैं, साथ ही अन्य ऑपरेटिंग सिस्टम विकल्प उपलब्ध हैं।',

  osMenu: kOf(vpsOsMenu),
  otherOs: 'अन्य ऑपरेटिंग सिस्टम',
  specifyOtherOs: '🔤 कृपया वह ऑपरेटिंग सिस्टम बताएं जिसे आप उपयोग करना चाहते हैं।',
  askVpsCpanel:
    '🛠️ क्या आप सर्वर प्रबंधन को आसान बनाने के लिए एक कंट्रोल पैनल जोड़ना चाहेंगे? WHM, Plesk, या कोई पैनल नहीं में से चुनें।',
  ...
  validCpanel: 'कृपया एक वैध कंट्रोल पैनल चुनें या इसे छोड़ दें।',
  askVpsDiskType: '💿 कृपया वह डिस्क प्रकार बताएं जिसे आप उपयोग करना चाहते हैं।',
  chooseValidDiskType: 'कृपया एक वैध डिस्क प्रकार चुनें।',
  failedFetchingAddress: 'पता प्राप्त करने में त्रुटि। कृपया कुछ समय बाद पुनः प्रयास करें।',
  vpsDiskTypeMenu: ['pd-standard', 'pd-balanced', 'pd-ssd'],
  askVpsMachineType: '💻 कृपया वह मशीन प्रकार बताएं जिसे आप उपयोग करना चाहते हैं।',
  chooseValidMachineType: 'कृपया एक वैध मशीन प्रकार चुनें।',
  vpsMachineTypeMenu: ['e2-micro', 'f1-micro'],
  vpsWaitingTime: '⚙️ लागत जानकारी प्राप्त की जा रही है... इसमें कुछ क्षण लगेंगे।',
  failedCostRetrieval: 'लागत जानकारी प्राप्त करने में विफल... कृपया कुछ समय बाद पुनः प्रयास करें।',

  errorPurchasingVPS: plan => `आपके ${plan} VPS प्लान को सेटअप करते समय कुछ समस्या हुई | ${statusCode}। 
                                                कृपया सहायता से संपर्क करें ${SUPPORT_USERNAME}।
                                                अधिक जानकारी के लिए देखें ${TG_HANDLE}।`,

  generateBillSummary: vpsDetails => `<strong>📋 आपके चयन का सारांश:</strong>

    <strong>•	बिलिंग प्लान:</strong> ${vpsPlans[vpsDetails.plan]}
    <strong>•	ऑटो-नवीनीकरण:</strong> नहीं
    ...
    <strong>•	ऑपरेटिंग सिस्टम:</strong> ${vpsDetails.os}
	  <strong>•	कंट्रोल पैनल:</strong>  ${
      vpsDetails.panel
        ? `${vpsDetails.panel} ${vpsDetails.panelMode === 'paid' ? `(भुगतानित)` : '(परीक्षण)'}`
        : 'कोई पैनल चयनित नहीं'
    }
	  <strong>•	SSH कुंजी:</strong> कोई लिंक नहीं
    <strong>•	डिस्क प्रकार:</strong> ${vpsDetails.diskType}
    <strong>•	मशीन प्रकार:</strong> ${vpsDetails.machineType}
    <strong>•	क्षेत्र:</strong> ${vpsDetails.regionName} ( ${vpsDetails.zone})

💰 लागत विवरण:
	  <strong>•	VPS लागत ([बिलिंग चक्र]):</strong> $${vpsDetails.totalPrice}
	  <strong>•	लाइसेंस लागत (यदि लागू हो):</strong> $0
	  <strong>•	कूपन छूट:</strong> -$${vpsDetails.couponDiscount}
	  <strong>•	कुल लागत:</strong> $${vpsDetails.couponApplied ? vpsDetails.newPrice : vpsDetails.totalPrice}

🎉 आप बचाते हैं: $${vpsDetails.couponDiscount}`,
  no: '❌ आदेश रद्द करें',
...
${CHAT_BOT_NAME}`,
  ...
  extraMoney: 'आपकी प्रति घंटे की योजना के लिए शेष राशि वॉलेट में जमा कर दी गई है।',
  paymentRecieved: `✅ भुगतान सफल हुआ! आपका VPS सेटअप किया जा रहा है। विवरण जल्द ही उपलब्ध होंगे और आपकी सुविधा के लिए आपके ईमेल पर भेज दिए जाएंगे।`,
  paymentFailed: `❌ भुगतान विफल। कृपया अपना भुगतान तरीका जांचें या पुनः प्रयास करें।`,

  lowWalletBalance: vpsName => `
आपके VPS प्लान के इंस्टेंस ${vpsName} को कम बैलेंस के कारण रोक दिया गया है।

कृपया अपने वॉलेट में टॉप-अप करें ताकि आप अपने VPS प्लान का उपयोग जारी रख सकें।
`,

  vpsBoughtSuccess: (info, vpsDetails, response) =>
    `🎉 आपका VPS तैयार है! आपके सर्वर का विवरण नीचे दिया गया है:
  
<strong>🚀 नाम:</strong> ${response.name}
<strong>💳 बिलिंग प्लान:</strong> ${vpsPlans[vpsDetails.plan]}
<strong>🛠️ कंट्रोल पैनल:</strong> ${vpsDetails.panel} ${vpsDetails.panelMode === 'paid' ? `(भुगतानित)` : '(परीक्षण)'}
<strong>🌐 सर्वर IP: </strong> ${response.networkInterfaces[0].networkIP}
<strong>💻 ऑपरेटिंग सिस्टम:</strong> ${vpsDetails.os}
<strong>⚙️ कॉन्फ़िगरेशन:</strong> ${vpsConfig[vpsDetails.config.name]} (${vpsDetails.config.vcpuCount}vCPU, ${
      vpsDetails.config.ramGb
    }GB RAM, ${vpsDetails.config.diskStorageGb}GB डिस्क, ${vpsDetails.config.bandwidthTB}TB बैंडविड्थ)
<strong>🌍 ज़ोन:</strong> ${vpsDetails.zone}
<strong>💿 डिस्क प्रकार:</strong> ${response.disks[0].deviceName}
    
📧 ये विवरण आपके पंजीकृत ईमेल पर भी भेज दिए गए हैं। कृपया इन्हें सुरक्षित रखें।
हमारी सेवा चुनने के लिए धन्यवाद।
${CHAT_BOT_NAME}
`,

  vpsHourlyPlanRenewed: (vpsName, price) => `
आपके VPS प्लान के इंस्टेंस ${vpsName} को सफलतापूर्वक नवीनीकृत कर दिया गया है।
आपके वॉलेट से ${price}$ काट लिया गया है।
`,

  bankPayVPS: (
    priceNGN,
    plan,
  ) => `कृपया नीचे "भुगतान करें" पर क्लिक करके ${priceNGN} NGN भेजें। एक बार लेन-देन की पुष्टि हो जाने के बाद, आपको तुरंत सूचित किया जाएगा और आपका ${
    vpsPlans[plan]
