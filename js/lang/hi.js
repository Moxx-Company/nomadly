...
<strong>✅ क्या आप आदेश को आगे बढ़ाना चाहते हैं?</strong>`,
  ...
  vpsSubscriptionData: (vpsData, expireDate) => `<strong>🗂️ आपकी सक्रिय सदस्यताएँ:</strong>

<strong>• VPS ${vpsData.name} </strong>– समाप्ति: ${expireDate} (स्वचालित नवीनीकरण: ${
...
<strong>• देय राशि :</strong> ${data.totalPrice}`,
  ...
  renewVpsPanelConfirmMsg: (
    data,
    vpsDetails,
  ) => `<strong>💳 क्या आप नियंत्रण पैनल का नवीनीकरण जारी रखना चाहते हैं?</strong>

<strong>📜 चालान सारांश</strong>
<strong>• जुड़ा हुआ VPS आईडी :</strong> ${vpsDetails.name}
<strong>• नियंत्रण पैनल :</strong> ${vpsDetails.cPanel}
<strong>• नवीनीकरण अवधि :</strong> 1 महीना
<strong>• नई समाप्ति तिथि :</strong> [नई तिथि]
<strong>• देय राशि :</strong> ${data.totalPrice}`,

  bankPayVPSRenewCpanel: (priceNGN, vpsDetails) =>
    `कृपया नीचे "भुगतान करें" पर क्लिक करके ${priceNGN} NGN भेजें। जैसे ही लेन-देन की पुष्टि होगी, आपको तुरंत सूचित किया जाएगा, और आपका VPS प्लान सक्रिय हो जाएगा और ${vpsDetails.cPanel} नियंत्रण पैनल नवीनीकृत किया जाएगा।`,
